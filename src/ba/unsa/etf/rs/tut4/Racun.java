...
public class Racun {
    ...
    static class StavkaRacuna { public Artikal artikli;private Integer kolicina;
    ...
    public String toString() { return "Racun{" + "id=" + id + ", cijena=" + cijena + '}'; }private ArrayList<StavkaRacuna> stavkeRacuna;
    public Racun() { stavkeRacuna = new ArrayList<>();}
    public void dodajStavku(Artikal artikal, int i) { stavkeRacuna.add(new StavkaRacuna(artikal,i));}
